...
export function GlassBlogCard({
  ...
  return (
    ...
    >
      <Card interactive={true} className="group relative h-full overflow-hidden rounded-2xl border-border/50 bg-card/30 backdrop-blur-md transition-all duration-300 hover:border-primary/50 hover:shadow-xl hover:shadow-primary/10">
        {/* Image Section */}
        ...
        <div className="flex flex-col gap-4 p-5">
          ...
          <div className="flex items-center justify-between border-t border-border/50 pt-4 z-10">
