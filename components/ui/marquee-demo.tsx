...
const skills = [
  { name: "Python", src: "/assets/logos/python.gif" },
  { name: "Java", src: "/assets/logos/java.gif" },
  { name: "C++", src: "/assets/logos/icons8-c++-96.png" },
  { name: "MySQL", src: "/assets/logos/sql.gif" },
  { name: "Flutter", src: "/assets/logos/flutter.gif" },
  { name: "Dart", src: "/assets/logos/icons8-dart-96.png" },
  { name: "Data Analysis", src: "/assets/logos/data-analysis.gif" },
  { name: "Video Editing", src: "/assets/logos/video-editing.gif" },
  { name: "VS Code", src: "/assets/logos/icons8-vs-code-96.png" },
  { name: "Tableau", src: "/assets/logos/icons8-tableau-software-96.png" },
  { name: "Excel", src: "/assets/logos/icons8-excel-96.png" },
];

// SVG icons for tools without image files
const SvgLogos: Record<string, React.FC> = {
  Git: () => (
    <svg className="h-8 w-8 shrink-0" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
  ...
  GitHub: () => (
    <svg className="h-8 w-8 shrink-0" viewBox="0 0 98 96" xmlns="http://www.w3.org/2000/svg">
  ...
  "Machine Learning": () => (
    <svg className="h-8 w-8 shrink-0 text-emerald-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    <div className="w-full relative bg-black/30 border-y border-white/5 backdrop-blur-sm">
      <Marquee pauseOnHover speed={35}>
        {allSkills.map((skill, index) => (
          ...
          >
            <div className="group-hover:scale-110 transition-transform duration-300 flex items-center justify-center w-8 h-8 shrink-0">
